...
describe "Chicago::Schema::Column#to_hash" do
  ...
  it "should have an :unsigned entry if relevant" do
    Chicago::Schema::Column.new(:id, :integer, :min => 0).to_hash[:unsigned].should be true
  end
  ...
  it "should be unsigned by default if a percentage" do
    Chicago::Schema::Column.new(:some_value, :percent).to_hash[:unsigned].should be true
  end
  ...
  it "should explicitly set the default to nil for timestamp columns" do
    Chicago::Schema::Column.new(:username, :timestamp).to_hash.has_key?(:default).should be true
